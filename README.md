...
| `GET/POST /api/authors/` | CRUD авторов (запись — библиотекарь) |
| `GET/POST /api/books/` | CRUD книг (запись — библиотекарь) |
| `GET/POST /api/loans/` | Список/создание выдачи (создание — библиотекарь) |
